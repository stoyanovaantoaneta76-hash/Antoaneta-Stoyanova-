...
class TestCSVProfileWriter:
    ...
    def test_write_to_path_valid_profile(self, tmp_path, sample_profile):
        """Test writing profile to CSV file path."""
    ...
    def test_write_to_path_creates_directories(self, tmp_path, sample_profile):
        ...
        writer = CSVProfileWriter()
        output_path = tmp_path / "subdir" / "nested" / "test_profile.csv"
    ...
    def test_write_to_bytes_valid_profile(self, sample_profile):
        """Test writing profile to CSV bytes."""
        writer = CSVProfileWriter()
    ...
    def test_supported_extensions(self):
        ...
        extensions = CSVProfileWriter.supported_extensions()
